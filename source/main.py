...
test_label1 = test_dataset.targets

with open("../EI339DataSet/DataSet.pkl", "rb") as fin:
...
save_pth = "../trained_models/RS18_09model_20classes.pth"
start = 0
...
for i in range(start, 100):
    ...
    with open("../log/train_loss.txt", "w", encoding="utf8") as fout:
    ...
    if (i + 1) % 10 == 0:
        ...
        report_accuracy(c, t)
        with open("../log/test_loss.txt", "w", encoding="utf8") as fout:
